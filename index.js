...
class Sprite {
    constructor({position,imageSrc}){this.position = position; this.image=new Image(); this.image.src = imageSrc}
    draw() {
...
const keys ={d:{pressed:false},a:{pressed:false},w:{pressed:false}}
